...
if __name__ == '__main__':
    ...
    out_res_pdf2.to_csv(os.path.join(out_path,"vgg_static_graph.csv"),index=False)
    ...
    if do_shape_info:
        ...
        tensor_res.to_csv(os.path.join(out_path,"vgg_tensor_graph.csv"),index=False)
